...
import 'package:weatherapp/rent_form_with_whatsapp.dart';
          ...
          const SizedBox(height: 20),
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => RentFormPage()),
                    );
                  },
                  child: const Text("Rent Umbrella"),
                ),
        ],
      ),
    );
